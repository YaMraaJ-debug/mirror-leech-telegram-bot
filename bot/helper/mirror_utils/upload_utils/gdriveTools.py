    ...
    def clone(self, link):
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>🗂️ 𝙁𝙞𝙡𝙚𝙣𝙖𝙢𝙚: </b><code>{meta.get("name")}</code>\n<b>📦 𝙎𝙞𝙯𝙚: </b>{get_readable_file_size(self.transferred_size)}'
                msg += '\n<b>⚙️ 𝙏𝙮𝙥𝙚: </b>Folder'
                msg += f'\n<b>📚 𝙎𝙪𝙗𝙁𝙤𝙡𝙙𝙚𝙧𝙨: </b>{self.total_folders}'
                msg += f'\n<b>📁 𝙁𝙞𝙡𝙚𝙨: </b>{self.total_files}'
                ...
                try:
                    ...
                    typ = 'File'
                try:
                    msg += f'\n<b>📦 𝙎𝙞𝙯𝙚: </b>{get_readable_file_size(int(meta.get("size")))}'
                    msg += f'\n<b>>⚙️ 𝙏𝙮𝙥𝙚: </b>{typ}'
                except TypeError:
                    pass
                if INDEX_URL is not None:
    ...
    def drive_list(self, fileName, stopDup=False, noMulti=False):
        ...
        for content in self.telegraph_content :
            self.path.append(Telegraph(access_token=telegraph_token).create_page(
                                                    title = '𝙔𝙖𝙢𝙧𝙖𝙖𝙟 𝗠𝗜𝗥𝗥𝗢𝗥 𝗭𝗢𝗡𝗘',
                                                    author_name='𝙔𝙖𝙢𝙧𝙖𝙖𝙟 𝗠𝗜𝗥𝗥𝗢𝗥 𝗭𝗢𝗡𝗘',
                                                    author_url='https://github.com/crazy-racer/mirror-leech-telegram-bot',
                                                    html_content=content
                                                    )['path'])
    ...
    def count(self, link):
        ...
        try:
            ...
            if drive_file['mimeType'] == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'\n\n<b>📦 𝙎𝙞𝙯𝙚: </b>{get_readable_file_size(self.total_bytes)}'
                msg += '\n\n<b>⚙️ 𝙏𝙮𝙥𝙚: </b>Folder'
                msg += f'\n<b>📚 𝙎𝙪𝙗𝙁𝙤𝙡𝙙𝙚𝙧𝙨: </b>{self.total_folders}'
                msg += f'\n<b>📁 𝙁𝙞𝙡𝙚𝙨: </b>{self.total_files}'
            else:
                msg += f'<b>🗂 𝙁𝙞𝙡𝙚𝙣𝙖𝙢𝙚: </b><code>{name}</code>'
                try:
